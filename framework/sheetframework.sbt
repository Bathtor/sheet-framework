...
lazy val sheetframework = crossProject.in(file(".")).
  ...
  settings(
    ...
    libraryDependencies += "com.lkroll.roll20" %%% "roll20-core" % "0.6.0-SNAPSHOT",
    libraryDependencies += "com.lkroll.roll20" %%% "roll20-sheet-model" % "0.6.0-SNAPSHOT",
  ...
  jvmSettings(
    ...
    libraryDependencies += "com.lihaoyi" %% "upickle" % "0.4.+",
